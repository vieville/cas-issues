...
<spring:eval expression="@casProperties.getProperty('auth.l1.dev.enabled')" var="isDev" />
<html lang="en">
<head>
  <meta charset="UTF-8" />
    ...
    <!-- START - NE PAS INDEXER -->
     <title>Service d'authentification (<spring:eval expression="@casProperties.getProperty('host.name')" />)</title>
     <!-- STOP - NE PAS INDEXER -->
...
<div id="conteneur_global">
			  ...
			  <div id="bienvenue">
                            ...
                            <c:if test="${isDev eq true}">
                                <h1><spring:message code="screen.welcome.label.welcome.test" /></h1>
                                <p><spring:message code="screen.welcome.left.test" /></p>
                            </c:if>                                
